  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', gap: 26, fontSize: 11, color: 'var(--gray)', letterSpacing: '.04em' }}>
        ...
        <div>BTC <b style={{ color: 'var(--up)', fontFamily: 'var(--mono)', fontWeight: 500 }}>$104,820</b></div>
        <div>S&amp;P 500 <b style={{ color: 'var(--up)', fontFamily: 'var(--mono)', fontWeight: 500 }}>+0.42%</b></div>
      </div>
    </header>
  );
}
